...
const ConditionSidebar = ({ access_list }) => {
          ...
          <i>
            ...
            >
              <circle
                ...
                r="3"
                stroke={
                  isHref("member", "memberdetails") ? "#1B95BC" : "#a6b0cf"
                }
                strokeWidth="2"
                strokeLinecap="round"
              ></circle>
              ...
              <path
                ...
                fill={isHref("member", "memberdetails") ? "#1B95BC" : "#a6b0cf"}
              ></path>
            </svg>
          </i>
          <span
            style={{
              color: isHref("member", "memberdetails") ? "#1B95BC" : "#a6b0cf",
              fontWeight: isHref("member", "memberdetails") ? "600" : "400",
            }}
            key="t-dashboards"
          >
            Members
          ...
          <i className="">
            ...
            >
              <path
                ...
                fill={
                  isHref("manageAdmins", "createAdmin") ? "#1B95BC" : "#a6b0cf"
                }
              />
            </svg>
          </i>
          <span
            style={{
              color: isHref("manageAdmins", "createAdmin")
                ? "#1B95BC"
                : "#a6b0cf",
              fontWeight: isHref("manageAdmins", "createAdmin") ? "600" : "400",
            }}
            key="t-dashboards"
          >
            Manage Admins
