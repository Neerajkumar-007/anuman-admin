...
import { getCategoryQuestion } from "../../Redux/Actions/admin/adminPanel";
...
const ManageQuestions = () => {
  ...
  useEffect(() => {
    if (categoryQuestions) {
      setSearchedMembers(categoryQuestions);
    }
  }, [categoryQuestions]);

  useEffect(() => {
    const newArr = categoryQuestions?.filter((data) =>
              ...
              <div className="row">
                <div className="col-12">
                  <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                    <div>
                      <span className="small_text">Manage Questions</span>
                    ...
                    <div className="card">
                      <div className="card-body">
                        <div className="d-flex justify-content-between align-items-center flex-wrap mb-3 position-relative">
                          <h4 className="title_text">Category: {categoryData?.title}</h4>
                          <span>
                            <Link>
                              <button
                                type="button"
